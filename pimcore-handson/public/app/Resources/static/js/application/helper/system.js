...
websiteRouter.emit(
    ...
    AbstractHelper.subclass({
        ...
        constructor: function() {
            ...
            this.set('name', 'system');

        },

        elementIsReadyInEditMode: function($container, selector) {
            ...
            if( !this.getRouter().getHelper('settings').getSystemVar('editMode') ) {
        ...
        getBreakpointName: function() {
            ...
            if ( Modernizr.mq('(max-width: 479px)') ) {
                return 'XS';
            } else if ( Modernizr.mq('(min-width: 480px) and (max-width: 767px)') ) {
                return 'TY';
